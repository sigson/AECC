...
namespace NetCoreServer
{
    ...
    public class HttpRequest
    {
        ...
        /// </summary>
        public byte[] BodyBytes { get { var result = new byte[_bodySize]; Array.Copy(_cache.Data, _bodyIndex, result, 0, _bodySize); return result; } }
        /// <summary>
        ...
        {
            char[] chars = body.ToArray();
            int length = body.IsEmpty ? 0 : Encoding.UTF8.GetByteCount(chars);
