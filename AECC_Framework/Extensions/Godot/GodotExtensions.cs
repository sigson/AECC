...
public static class GodotExtensions
{
    ...
    {
        #if GODOT
        var result = path.Replace("\\", AECC.Harness.Services.GlobalProgramState.instance.PathSystemSeparator).Replace("/", AECC.Harness.Services.GlobalProgramState.instance.PathSystemSeparator);
