...
namespace AECC.Core
{
    ...
    public abstract class IDObject
    {
        ...
        // Static-generic фаст-путь: горячее чтение статического поля вместо словарного
        // лукапа на каждый вызов. 0 = «ещё не зарегистрирован» → повторный резолв
        // (безопасно при любой очерёдности инициализации; тип с легитимным id 0 —
        // IECSObject — просто не кэшируется). Незарегистрированный тип бросает
